...
const IndexPage = () => (
  <Layout>
    ...
    <Box>
      ...
      <Paragraph>💬 For all inquiries, e-mail <a target="_blank" href="mailto:chris@sbtp.xyz">chris@sbtp.xyz</a> or DM <strong>CJ Crispy#6052</strong> on Discord</Paragraph>
    </Box>
  </Layout>
)
